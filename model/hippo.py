...
class HiPPO(nn.Module):
    def __init__(self, params):
        ...
        if "ToolUse" in env_name:
            ...
            causal_params = params.env_params.manipulation_env_params.causal_env_params
            num_objs = causal_params.num_movable_objects + \
                       causal_params.num_unmovable_objects + \
                       causal_params.num_random_objects
        else:
